...
#    return ssss * os_begin(0,g1,g2,g3,g4)

def os_begin(m, g1, g2, g3, g4):
    '''Starts recursion
    '''
    l_1 = g1[0]
    l_2 = g2[0]
    ...
    l_total = 12 # TODO currently hardcoded for debugging, always switch this 
    ...
    if l_1[0] > 0:
        return os_recursion(0, m, *os_gaussian_factory(0, g1, g2, g3, g4))
    elif l_1[1] > 0:
        return os_recursion(1, m, *os_gaussian_factory(1, g1, g2, g3, g4))
    elif l_1[2] > 0:
        return os_recursion(2, m, *os_gaussian_factory(2, g1, g2, g3, g4))
    elif l_2[0] > 0:
        return os_recursion(0, m, *os_gaussian_factory(0, g2, g1, g4, g3))
    elif l_2[1] > 0:
        return os_recursion(1, m, *os_gaussian_factory(1, g2, g1, g4, g3))
    elif l_2[2] > 0:
        return os_recursion(2, m, *os_gaussian_factory(2, g2, g1, g4, g3))
    elif l_3[0] > 0:
        return os_recursion(0, m, *os_gaussian_factory(0, g3, g4, g1, g2))
    elif l_3[1] > 0:
        return os_recursion(1, m, *os_gaussian_factory(1, g3, g4, g1, g2))
    elif l_3[2] > 0:
        return os_recursion(2, m, *os_gaussian_factory(2, g3, g4, g1, g2))
    elif l_4[0] > 0:
        return os_recursion(0, m, *os_gaussian_factory(0, g4, g3, g2, g1))
    elif l_4[1] > 0:
        return os_recursion(1, m, *os_gaussian_factory(1, g4, g3, g2, g1))
    elif l_4[2] > 0:
        return os_recursion(2, m, *os_gaussian_factory(2, g4, g3, g2, g1))
    else:
        return boys_evals[m] #* ssss

def os_recursion(i, m, g1, g2, g3, g4, g5, g6, g7, g8):
    '''
    Parameters
    ----------
    i: int
    ...
    if not np.allclose(r_7[i],r_5[i]):
    #if r_7[i] != r_5[i]:
