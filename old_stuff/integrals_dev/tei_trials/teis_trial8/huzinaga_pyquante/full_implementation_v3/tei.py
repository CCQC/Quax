...
def fill_shell_quartet(G, la,lb,lc,ld, A, B, C, D, aa, bb, cc, dd, c1, c2, c3, c4): 
#L,xyza,xyzb,xyzc,xyzd,alphaa,alphab,alphac,alphad,c1,c2,c3,c4):
    """
    Given a two electron integral array and a set of shell quartet data,
    fill in values of array and return it.
    """

    # Generate all angular momentum combinations
