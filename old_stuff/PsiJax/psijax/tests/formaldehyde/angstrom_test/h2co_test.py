...
bohr2ang_co2018 = 5.29177210903e-11 * 1e10

geom = np.array([[ 0.000000000000,     0.000000000000,    -1.141817200432],
                 [ 0.000000000000,     0.000000000000,     1.138747061525],
                 [-0.000000000000,     1.762942010951,    -2.238660220220],
                 [ 0.000000000000,    -1.762942010951,    -2.238660220220]])

#print(geom * bohr2ang_co2018)

molecule = psi4.geometry("""
                         0 1
                         C  0.            0.           -0.6042236415
                         O  0.            0.            0.6025989939
                         H -0.            0.9329087363 -1.1846479715
                         H  0.           -0.9329087363 -1.1846479715
                         symmetry c1
                         units ang
                         """)
