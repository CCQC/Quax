...
class CheckpointFunction(torch.autograd.Function):
    ...
    @staticmethod
    def backward(ctx, *gradient_args):
        print("CHECKPOINT BACKWARD INITIALIZED")
        ...
        print('outputs')
        print(outputs)
        torch.autograd.backward(outputs, gradient_args, create_graph=True)
        grads = tuple(inp.grad if isinstance(inp, torch.Tensor) else inp
                      for inp in detached_inputs)


        print("CHECKPOINT BACKWARD TERMINATED")
