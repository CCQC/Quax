...
def B_term(i1,i2,r1,r2,u,l1,l2,l3,l4,Px,Ax,Bx,Qx,Cx,Dx,gamma1,gamma2,delta):
    ...
    #val = (-1)**i2 * fB(i2,l3,l4,Qx,Cx,Dx,r2,gamma2) \

    #val = fB(i1,l1,l2,Px,Ax,Bx,r1,gamma1) \

    #val = fB(i1,l1,l2,Px,Ax,Bx,r1,gamma1) \
    #       * (-1)**i2 * fB(i2,l3,l4,Qx,Cx,Dx,r2,gamma2) \
    #       * (-1)**u * fact_ratio2(i1- 2 * r1 + i2 - 2 * r2, u) \
    #       * (Qx-Px)**(i1 - 2 * r1 + i2 - 2 * r2 - 2 * u) \
    #       / delta**(i1 - 2 * r1 + i2 - 2 * r2 - u)
    return val
...
def B_array(l1,l2,l3,l4,p,a,b,q,c,d,g1,g2,delta):
    ...
    with loops.Scope() as s:
      ...
      #s.p,s.a,s.b,s.q,s.c,s.d,s.g1,s.g2,s.delta = p,a,b,q,c,d,g1,g2,delta
      s.B = np.zeros(12)

      #s.i1 = s.l1 + s.l2 
      #s.i2 = s.l3 + s.l4 

      s.i1 = l1 + l2  # THIS IS THE BUG. DONT MAKE OUT OF MUTABLE STATE
      s.i2 = l3 + l4 
        ...
        for _ in s.while_range(lambda: s.r1 > -1):
          ...
          for _ in s.while_range(lambda: s.i2 > -1):
            ...
            for _ in s.while_range(lambda: s.r2 > -1):
              #s.u = (s.i1 - s.r1 + s.i2 - s.r2 ) //2  #this is correct
              s.u = (s.i1 + s.i2) // 2 - s.r1 - s.r2 
              for _ in s.while_range(lambda: s.u > -1):
                I = s.i1 - 2 * s.r1 +  s.i2 - 2 * s.r2 - s.u 
                #term = B_term(s.i1,s.i2,s.r1,s.r2,s.u,s.l1,s.l2,s.l3,s.l4,s.p,s.a,s.b,s.q,s.c,s.d,s.g1,s.g2,s.delta) # problem
                #term = B_term(s.i1,s.i2,s.r1,s.r2,s.u,l1,l2,l3,l4,s.p,s.a,s.b,s.q,s.c,s.d,s.g1,s.g2,s.delta) # problem
                #term = B_term(s.i1,s.i2,s.r1,s.r2,s.u,l1,l2,l3,l4,p,a,b,q,c,d,g1,g2,delta) # problem
                term = 1
