...
def vrr(xyza,lmna,alphaa, xyzb,alphab, xyzc,lmnc,alphac, xyzd,alphad,M):
    ...
    with loops.Scope() as S:
        ...
        S.vrr_terms = np.zeros((3,3,3,3,3,3,AM+1)) 
        S.dummy = 0.
...
#xyza = np.asarray(onp.tile(xyza,(10000,1)))
#xyzb = np.asarray(onp.tile(xyzb,(10000,1)))
#xyzc = np.asarray(onp.tile(xyzc,(10000,1)))
#xyzd = np.asarray(onp.tile(xyzd,(10000,1)))
#lmna = np.asarray(onp.tile(np.array([1,2,1]),(10000,1)))
#lmnb = np.asarray(onp.tile(np.array([0,0,0]),(10000,1)))
#lmnc = np.asarray(onp.tile(np.array([1,0,2]),(10000,1)))
#lmnd = np.asarray(onp.tile(np.array([0,0,0]),(10000,1)))
#
