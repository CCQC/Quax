...
def kinetic_ps(Ax, Ay, Az, Cx, Cy, Cz, alpha_bra, alpha_ket, c1, c2):
    ...
    """
    oot_alpha_bra = 1 / (2 * alpha_bra)
    first_term = np.asarray(jax.jacfwd(kinetic_ss, (0,1,2))(Ax, Ay, Az, Cx, Cy, Cz, alpha_bra, alpha_ket, c1, c2))
    return oot_alpha_bra * first_term
...
def potential_ps(Ax, Ay, Az, Cx, Cy, Cz, geom, charge, alpha_bra, alpha_ket, c1, c2):
    ...
    """
    oot_alpha_bra = 1 / (2 * alpha_bra)
    first_term = np.asarray(jax.jacfwd(potential_ss, (0,1,2))(Ax, Ay, Az, Cx, Cy, Cz, geom, charge, alpha_bra, alpha_ket, c1, c2))
    return oot_alpha_bra * first_term
