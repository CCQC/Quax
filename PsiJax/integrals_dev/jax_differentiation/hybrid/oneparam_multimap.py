...
def build_overlap(Ax, Ay, Az, Cx, Cy, Cz, centers1, centers2, basis_data, primitive_locations):
...
Ax, Ay, Az = geom[0]
Cx, Cy, Cz = geom[1]
quar = jax.jacfwd(jax.jacfwd(jax.jacfwd(jax.jacfwd(build_overlap))))(Ax, Ay, Az, Cx, Cy, Cz, centers1, centers2, basis_data, primitive_locations)
print(quar.shape)
#print(hess)
