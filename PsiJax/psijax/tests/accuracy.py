...
basis_name = 'cc-pvdz'
psi4.set_options({'basis': basis_name, 'scf_type': 'pk', 'mp2_type':'conv', 'e_convergence': 1e-10, 'diis': False, 'd_convergence':1e-10, 'puream': 0, 'points':5, 'fd_project':False})
...
for method in ['scf', 'mp2', 'ccsd(t)']:
    ...
    print("{} energies match: ".format(method), onp.allclose(psi_e, psijax_e, rtol=0.0, atol=1e-6))
print("\n")
print("\n")
...
for method in ['scf', 'mp2', 'ccsd(t)']:
    ...
    print("{} gradients match: ".format(method),onp.allclose(psijax_deriv, psi_deriv, rtol=0.0, atol=1e-6))
print("\n")
print("\n")
...
for method in ['scf', 'mp2', 'ccsd(t)']:
    ...
    print("{} hessians match: ".format(method),onp.allclose(psijax_deriv, psi_deriv,rtol=0.0,atol=1e-4))
print("\n")
print("\n")
